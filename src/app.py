...
# ==========================================
    ...
    if "Compiles standard and ad hoc reports" in selected_key_tab:
        ...
        # Apply filter and sort locally to this report
        ...
        st.table(raw_fac_data[["faculty_name", "department_assignment", "appointment_track", "faculty_staff_status", "tenure_years_at_institution"]].astype(str))
